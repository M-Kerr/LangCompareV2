...
#print("Size: " + str(sys.getsizeof(duration)))
#print("Size: " + str(sys.getsizeof(duration_us)))
#print("Size: " + str(sys.getsizeof(duration_ms)))
#print("ns: " + str(duration))
#print("us: " + str(duration_us))
#print("ms: " + str(duration_ms))
