...
#. Create a user-code directory for the language within the ``code/`` directory.
   This is the directory the user places the code they want to test for the 
   language. E.g., ``code/cpp/``.
