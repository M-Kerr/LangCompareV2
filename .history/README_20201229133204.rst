...
++++++++++++++++++++++++
    **Constructor**
        The constructor passes the name of the language the subclass
        represents into the ``Code`` constructor.

        Adds the language's user-code directory to the ``file_name`` parameter,
        forwarding the remaining parameters to the ``Code`` constructor.
