...
The compile and run calls should support the user adding a single file directly
in the ``code/<language>/`` directory, or multiple files within a package.

Throw a Compile_And_Run_Failure in the event of a failure during the
